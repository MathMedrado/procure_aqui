...
import '../components/smallPurpleButton.dart';

class SearchProduct extends StatefulWidget {
  SearchProduct({required this.productName, super.key});
              ...
              return snapshot.data!.length > 0 ? SingleChildScrollView(
                child: Column(
                  children: [
                    Container(
                      ...
                      child:  Text(
                        'O produto pesquisado foi: ${widget.productName}',
                        style: TextStyle(
                          fontSize: 22,
                        ),
                      ),
                ...
                children: [
                  Container(
                    child:  Center(
                      child: Text(
                        'O produto buscado ${widget.productName} não foi encontrado',
